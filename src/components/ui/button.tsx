...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-medium hover:bg-primary/90 hover:shadow-premium hover:scale-105",
        destructive:
        ...
        hero: "bg-gradient-hero-premium text-white shadow-premium hover:shadow-glow hover:scale-105 border-0",
        premium: "bg-gradient-premium text-white shadow-elegant hover:shadow-glow hover:scale-105",
        minimal: "bg-background border-2 border-border text-foreground hover:bg-muted hover:border-primary/50",
      },
      size: {
